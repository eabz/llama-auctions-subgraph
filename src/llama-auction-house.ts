...
import { Auction, AuctionGlobalConfiguration, CurrentAuction } from '../generated/schema'
...
export function handleAuctionTimeBufferUpdated(event: AuctionTimeBufferUpdatedEvent): void {
...
export function handleAuctionMinBidIncrementPercentageUpdated(
  ...
  entity.min_bid_increment_percentage = event.params._min_bid_increment_percentage
  entity.save()
}
